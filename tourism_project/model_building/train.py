...
mlflow.set_experiment("mlops-tourismproject-training-experiment1")

api = HfApi()


Xtrain_path = "hf://datasets/datanai-yawarkhan/Tourism-Package-Prediction/Xtrain.csv"
Xtest_path = "hf://datasets/datanai-yawarkhan/Tourism-Package-Prediction/Xtest.csv"
ytrain_path = "hf://datasets/datanai-yawarkhan/Tourism-Package-Prediction/ytrain.csv"
ytest_path = "hf://datasets/datanai-yawarkhan/Tourism-Package-Prediction/ytest.csv"
...
with mlflow.start_run():
    ...
    model_path = "best_tourismpackageprediction_model_v1.joblib"
    ...
    repo_id = "datanai-yawarkhan/tourismpackageprediction-model"
    repo_type = "model"
    ...
    # create_repo("tourismpackageprediction-model", repo_type="model", private=False)
    api.upload_file(
        path_or_fileobj="best_tourismpackageprediction_model_v1.joblib",
        path_in_repo="best_tourismpackageprediction_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
